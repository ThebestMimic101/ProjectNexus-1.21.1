...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> NUCLEAR_REACTOR_CORE = registerBlock("nuclear_reactor_core",
            () -> new Block(BlockBehaviour.Properties.of().strength(6f)));
    ...
    public static final DeferredBlock<Block> NEXUS_BEACON = registerBlock("nexus_beacon",
            () -> new Block(BlockBehaviour.Properties.of().strength(5f).lightLevel(s -> 12)));
    ...
    public static final DeferredBlock<Block> NEXUS_CRYSTAL_ORE = registerBlock("nexus_crystal_ore",
            () -> new Block(BlockBehaviour.Properties.of().strength(4f).lightLevel(s -> 7)));

    // ===== Machines / Custom =====
    public static final DeferredBlock<Block> ATOMIZER = registerBlock("atomizer",
            () -> new Block(BlockBehaviour.Properties.of().strength(5f).requiresCorrectToolForDrops()));

    public static final DeferredBlock<Block> PRESSER = registerBlock("presser",
            () -> new Block(BlockBehaviour.Properties.of().strength(5f).requiresCorrectToolForDrops()));

    public static final DeferredBlock<Block> UNKNOWN_ORE = registerBlock("unknown_ore",
            () -> new Block(BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()));

    public static final DeferredBlock<Block> RADIATION_BLOCK = registerBlock("radiation_block",
            () -> new Block(BlockBehaviour.Properties.of().strength(6f).lightLevel(state -> 10)));

    public static final DeferredBlock<Block> VOID_BLOCK = registerBlock("void_block",
            () -> new Block(BlockBehaviour.Properties.of().strength(10f).noOcclusion()));
